# this code is based on the TNTE_VarFit_v3 code, the major modification is that the credit limit
# is rand in each generation v2 added a batch functionality to the code to allow for greater than 100 run sims
...
for batch in 7:10
    ...
    FileName = string(workDir,"/Data/Batches/",string(inf*100)[1:end-2],"_PercentInf_EC_Limit_Variable_",CredSwitch,"_FitEff_",OrgFitBalance,"_TNTE_",Timing,"_Batch_",batch,".jld2")
