# this code is based on the TNOE_v3 code, the major modification is that
#  credit limit follows pulsed periods of low then high credits. 50 gens at .1 50 gens at 1, repeating
...
for batch in 7:10
    ...
    FileName = string(workDir,"/Data/Batches/",string(inf*100)[1:end-2],"_PercentInf_EC_Limit_Variable_",CredSwitch,"_FitEff_",OrgFitBalance,"_TNOE_",Timing,"_Batch_",batch,".jld2")
