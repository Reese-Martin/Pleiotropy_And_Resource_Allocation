...
# this script performs simulations of One effector (shared effector) host evolution with parasites
# batch number is used to run mutliple batches of 100 simulations
    ...
    while gen <= Generations
        ...
        for i in 1:NumHosts
            if i <= NumPars
                ...
                #calc the area under universal effector
...
for cred in CredLimits #cycles through specified infections chances, conducts (Runs) simulations at a given level of infection 
    for batch in 1:10
        ...
        FileName = string(workDir,"/Data/Batches/",string(inf*100)[1:end-2],"_PercentInf_EC_Limit_",string(Credits*100)[1:end-2],"_FitEff_",OrgFitBalance,"_TNOE_",Timing,"_Batch_",batch,".jld2")
